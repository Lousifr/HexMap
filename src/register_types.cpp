...
void initialize_hexmap_module(ModuleInitializationLevel p_level) {
	if (p_level == MODULE_INITIALIZATION_LEVEL_SCENE) {
		...
		ClassDB::register_class<HexCell>();
	} else {
		return;
	}
...
extern "C" {
// Initialization.
GDExtensionBool GDE_EXPORT hexmap_library_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, const GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization) {
